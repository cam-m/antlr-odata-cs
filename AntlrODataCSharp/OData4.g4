...
@lexer::members {
public Schema OdataSchema;

public static OData4Lexer buildOData4Lexer(ICharStream input, Schema schema) {
    OData4Lexer instance = new OData4Lexer(input);
...
public static OData4Parser buildOData4Parser(ITokenStream input, Schema schema) {
	    OData4Parser instance = new OData4Parser(input);
	    instance.OdataSchema = schema;
	    return instance;
	}
	
	
	private bool isUnboundFunctionName(string name) {
	    if (name == null) {
	        return false;
	    }
	    return this.OdataSchema != null ? this.OdataSchema.functionByName(name) != null : false;
	}
}
// Parser
odataRelativeURI
...
singleNavigationExpr
    ...
    | FWD_SLASH parameterAlias {NotifyErrorListeners("Aliases are not valid in navigation expressions.");}
    ;
